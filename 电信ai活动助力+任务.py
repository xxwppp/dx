...
"""
需要安装的依赖：requests curl_cffi pycryptodome
账号变量：AI096_ACCOUNTS 格式"手机号#密码"，多个账号用 & 或换行分隔
"""
import os
import time
import json
...
FIXED_PRE_ASSIST_INVITATION_CODE = "cf289dacd752a2d21605a51a7147cee27729b5b7eb2c111f7856d33bb552acce"
FIXED_PRE_ASSIST_INVITATION_LINK = "https://ai.imusic.cn/h5v/fusion/ai-luck-win?cc=156000008410&isshare=0&invitationCode=cf289dacd752a2d21605a51a7147cee27729b5b7eb2c111f7856d33bb552acce"
...
def prompt_pre_assist_targets():
    target_entries = parse_pre_assist_targets([FIXED_PRE_ASSIST_INVITATION_LINK])
    return target_entries
